			    ...
			    export NIX_PATH="''${NIX_PATH}:darwin-config=/Users/${username}/config/configuration.nix:/Users/${username}/.nix-defexpr/channels"
                    ...
                    vscode = {
                        ...
                        userSettings = {
                            ...
                            "java.jdt.ls.vmargs" = "-XX:+UseParallelGC -XX:GCTimeRatio=4 -XX:AdaptiveSizePolicyWeight=90 -Dsun.zip.disableMemoryMapping=true -Xmx1G -Xms100m -javaagent:\"/home/novafacing/.vscode/extensions/gabrielbb.vscode-lombok-1.0.1/server/lombok.jar\"";
                            ...
                            "settingsSync.ignoredSettings" = ["-python.formatting.blackPath"];
                            ...
                            "vim.statusBarColors.commandlineinprogress" = ["#32302f" "#89b482"];
                            ...
                            "vim.statusBarColors.searchinprogressmode" = ["#32302f" "#89b482"];
                            ...
                            "vim.statusBarColors.easymotioninputmode" = ["#32302f" "#e78a4e"];
